...
def train_naive_bayes_predictor(crypto_id='bitcoin', days=7):
    """
    Entrena modelo Naive Bayes para predicción de precio de criptomonedas.
    ...
    """
    logger.info(f"Iniciando entrenamiento Naive Bayes para {crypto_id}")
    ...
    model_path = save_model(model, f"{crypto_id}_naive_bayes_{timestamp}")
...
if __name__ == '__main__':
    logger.info("="*60)
    logger.info("BITCOIN NAIVE BAYES PREDICTOR")
    logger.info("="*60)
